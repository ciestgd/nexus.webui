<template>
    <Dialog title="Reporting regional packet" height="145" width="300"  :isCollapse="true" :isContentDraggable="false">
        <div class="data-content">
            <ul>
                <li @click="showEJReport"><img :src="statisticiansPng" alt="" />Display Reporting regional packet</li>
                <el-divider style="margin: 0px" />
                <li @click="handleEjReportClear"><img :src="clearPng" alt="" />Clear Reporting regional packet</li>
            </ul>
        </div>
    </Dialog>
</template>
<script setup>
import statisticiansPng from '@/assets/images/header-icon/statisticians.png';

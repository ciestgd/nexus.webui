<template>
    <Dialog title="Monitor Sites" height="145" width="300"  :isCollapse="true" :isContentDraggable="false">
        <div class="data-content">
            <ul>
                <li @click="showMonistorSite"><img :src="sitePng" alt="" />Display Monitor Sites</li>
                <el-divider style="margin: 0px" />
                <li @click="clearMonistorSiteMap"><img :src="clearPng" alt="" />Clear Monitor Sites</li>
            </ul>
        </div>
    </Dialog>
</template>
<script setup>
import sitePng from '@/assets/images/header-icon/site.png';
